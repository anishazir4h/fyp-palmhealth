"""
MobileNet-V2 Classification Report Generator
Evaluates the MobileNet-V2 palm health classifier and generates detailed metrics
"""
...
def load_mobilenet_model(model_path, num_classes=2):
    """Load trained MobileNet-V2 model"""
    print(f"Loading model from {model_path}...")
    
    # Create MobileNet-V2 architecture
...
def plot_confusion_matrix(y_true, y_pred, class_names, output_path):
    ...
    plt.title('Confusion Matrix - MobileNet-V2 Palm Health Classification', 
...
def generate_classification_report(y_true, y_pred, class_names, output_dir):
    ...
    with open(report_path, 'w') as f:
        f.write("=" * 70 + "\n")
        f.write("MobileNet-V2 Palm Health Classification Report\n")
        f.write("=" * 70 + "\n\n")
...
def main():
    ...
    OUTPUT_DIR = Path("runs/detect/MobileNetV2_Classification_Augmented/evaluation_results")
    
    # Create output directory
    OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
    
    print("\n" + "=" * 70)
    print("MobileNet-V2 Classification Evaluation")
    print("=" * 70)
    print(f"\nModel: {MODEL_PATH}")
    ...
    # Load model
    model = load_mobilenet_model(MODEL_PATH, num_classes=2)
