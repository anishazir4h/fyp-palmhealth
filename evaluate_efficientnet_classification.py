"""
EfficientNet-B0 Classification Report Generator
Evaluates the EfficientNet-B0 palm health classifier and generates detailed metrics
"""
...
def plot_confusion_matrix(y_true, y_pred, class_names, output_path):
    ...
    plt.title('Confusion Matrix - EfficientNet-B0 Palm Health Classification', 
...
def generate_classification_report(y_true, y_pred, class_names, output_dir):
    ...
    with open(report_path, 'w') as f:
        f.write("=" * 70 + "\n")
        f.write("EfficientNet-B0 Palm Health Classification Report\n")
        f.write("=" * 70 + "\n\n")
...
def main():
    ...
    OUTPUT_DIR = Path("runs/detect/EfficientNetB0_Classification_Augmented/evaluation_results")
    
    # Create output directory
    OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
    
    print("\n" + "=" * 70)
    print("EfficientNet-B0 Classification Evaluation")
    print("=" * 70)
    print(f"\nModel: {MODEL_PATH}")
    ...
    # Load model
    model = load_efficientnet_model(MODEL_PATH, num_classes=2)
